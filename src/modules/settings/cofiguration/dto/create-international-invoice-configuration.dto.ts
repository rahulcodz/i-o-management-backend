...
export class CreateInternationalInvoiceConfigurationDto {
    @ApiProperty({ required: false, description: 'PIN Code' })
    @IsOptional()
    @IsString()
    pinCode?: string;

    @ApiProperty({ required: true, description: 'Declaration Export' })
    @IsNotEmpty()
    @IsString()
    ...
    @ApiProperty({ required: false, description: 'Invoice Series Setting Based On', default: 'General Setting For All Invoice' })
    @IsOptional()
    @IsString()
    invoiceSeriesSettingBasedOn?: string;

    @ApiProperty({ required: false, description: 'PI Series Setting Based On', default: 'General Setting For All PI' })
    @IsOptional()
    @IsString()
    ...
    @ApiProperty({ required: false, description: 'Invoice Start From', default: 0 })
    @IsOptional()
    @IsInt()
    @Min(0)
    ...
    @ApiProperty({ required: false, description: 'PI Start From', default: 0 })
    @IsOptional()
    @IsInt()
    @Min(0)
    piStartFrom?: number;
    ...
    @ApiProperty({ required: false, description: 'Quotation Start From', default: 0 })
    @IsOptional()
    @IsInt()
    @Min(0)
    ...
    @ApiProperty({ required: false, description: 'P.O. Start From', default: 0 })
    @IsOptional()
    @IsInt()
    @Min(0)
    poStartFrom?: number;
    ...
    @ApiProperty({ required: false, description: 'Service P.O. Start From', default: 0 })
    @IsOptional()
    @IsInt()
    @Min(0)
    ...
    @ApiProperty({ required: false, description: 'PI/Invoice No. Editing', default: true })
    @IsOptional()
    @IsBoolean()
